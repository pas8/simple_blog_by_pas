...
const HeaderMenu = () => {
  ...
  const menuItemsArr = [
   ...
   
    {
     ...
     {
      caption: 'Git hub repo',
      viewBox: '151 64 24 24',
      ...
      onClick: () => push('https://github.com/pas8/simple_blog_by_pas')
    },
  ];
            ...
            contentChildren={
              <>
                ...
                <DialogMenuContentContainer>
                  {menuItemsArr.map(({ d, onClick, caption, viewBox = '0 0 24 24' }) => {
                    return (
                      <Subtitle onClick={onClick} className={'item'} key={d}>
                        <svg viewBox={viewBox} width={42} height={42}>
